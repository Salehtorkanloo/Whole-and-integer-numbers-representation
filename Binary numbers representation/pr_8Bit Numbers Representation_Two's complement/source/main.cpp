...
int main(char** args)
{
    ...
    cout << "whole numbers representation with signed 8 bit range in two's complement" << endl;

    while(true){
        cout << "please enter a number in the range [-128,+127]" << endl;
        ...
        if(a >= 0)
            ...
            cout << " in two's complement scheme is:" << endl;
