...
namespace Sali{
    ...
    namespace IntRepresentation{
            struct S8BitBinary{
                ...
                friend S8BitBinary operator + (S8BitBinary& b, const int& s){
                    if(s > 1 || s < 0)
                        cout << "Mother fucker stupid! the number you add must be either 0 or 1!";
                    char i = 0;
                    while(true){
                        b[i] += s;
                        if(b[i] > 1){
            ...
            static S8BitBinary Rep(int numberToRepresent){
                ...
                int originalNumberToRepresent = numberToRepresent;
                ...
                if(originalNumberToRepresent < 0){
                    cout << "Hello, world\n";
